...
if (isset($_SESSION['id']) && isset($_SESSION['username']) && isset($_SESSION['control_num'])) {
    $showAlert = false;
...
if (isset($_SESSION['id'])) {
    ...
    TOR, pastor_reco, stud_image, form137, church_name, church_address, name_pastor, pastor_no, ministry_involved FROM applicants WHERE id = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        $TOR_link = !empty($row['TOR']) ? "..{$row['TOR']}" : null;
        $pastor_reco_link = !empty($row['pastor_reco']) ? "../uploads/{$row['pastor_reco']}" : null;
        $stud_image_link = !empty($row['stud_image']) ? "../uploads/{$row['stud_image']}" : null;
        $form137_link = !empty($row['form137']) ? "../uploads/{$row['form137']}" : null;
    ...
    <select name="course_id" id="course" class="form-control" required>
        ...
        ?>
            ...
            <!-- <div class="form-row">
                <div class="form-group">
                    <i class="fas fa-user"></i>
                    <input type="text" name="height" placeholder="Height (cm)" value="<?php echo htmlspecialchars(isset($height) && $height != 0 ? $height : ''); ?>"">
                </div>
                <div class="form-group">
                    <i class="fas fa-user"></i>
                    <input type="text" name="weight" placeholder="Weight (kg)" value="<?php echo htmlspecialchars(isset($weight) && $weight != 0 ? $weight : ''); ?>">
                </div>
            </div> -->
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="date" name="date_birth" id="date_birth" required value="<?php echo htmlspecialchars($date_birth); ?>">
                </div>
                <div class="form-group">
                    <i class="fas fa-map-marker-alt"></i>
                    <input type="text" name="birthplace" id="birthplace" placeholder="Birth Place" required value="<?php echo htmlspecialchars($birthplace); ?>">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="radio" name="sex" value="Male" required <?php echo ($sex === 'Male') ? 'checked' : ''; ?>> Male
                    <input type="radio" name="sex" value="Female" required <?php echo ($sex === 'Female') ? 'checked' : ''; ?>> Female
                </div>
                <div class="form-group">
                    <i class="fas fa-flag"></i>
                    <input type="text" name="nationality" placeholder="Nationality" required value="<?php echo htmlspecialchars($nationality); ?>">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="religion" placeholder="Religion" required value="<?php echo htmlspecialchars($religion); ?>">
                </div>
                <div class="form-group">
                    <i class="fas fa-phone"></i>
                    <input type="text" name="contact_no" placeholder="Contact Number" required value="<?php echo htmlspecialchars(isset($contact_no) && $contact_no != 0 ? $contact_no : ''); ?>">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" name="civil_status" placeholder="Civil Status" required value="<?php echo htmlspecialchars($civil_status); ?>">
                </div>
                <div class="form-group">
        ...
        <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="high_school" class="form-control" placeholder="High School Name" required value="<?php echo htmlspecialchars($high_school); ?>">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <i class="fas fa-calendar"></i>
                    <input type="number" name="high_year_graduated" class="form-control" placeholder="High School Year Graduated" required value="<?php echo htmlspecialchars(isset($high_year_graduated) && $high_year_graduated != 0 ? $high_year_graduated : ''); ?>">
                </div>
                <div class="form-group col-md-6">
                    <i class="fas fa-university"></i>
                    <input type="text" name="college_school" class="form-control" placeholder="College School" required value="<?php echo htmlspecialchars($college_school); ?>">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="college_course" class="form-control" placeholder="College Course" required value="<?php echo htmlspecialchars($college_course); ?>">
                </div>
                <div class="form-group col-md-6">
                    <i class="fas fa-calendar"></i>
                    <input type="number" name="college_year_graduated" id="college_year_graduated" class="form-control" placeholder="College Year Graduated" required value="<?php echo htmlspecialchars(isset($college_year_graduated) && $college_year_graduated !=0 ? $college_year_graduated : '');?>">
                </div>
            </div>

            <!-- Vocational School and Course -->
            <!-- <div class="form-row">
                <div class="form-group col-md-6">
                    <i class="fas fa-school"></i>
                    <input type="text" name="vocational_school" class="form-control" placeholder="Vocational School Name" required value="<?php echo htmlspecialchars($vocational_school); ?>">
                </div>
                <div class="form-group col-md-6">
                    <i class="fas fa-book"></i>
                    <input type="text" name="vocational_course" class="form-control" placeholder="Vocational School Course" required value="<?php echo htmlspecialchars($vocational_course); ?>">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <i class="fas fa-calendar"></i>
                    <input type="number" name="vocational_year_graduated" class="form-control" placeholder="Vocational Year Graduated" required value="<?php echo htmlspecialchars($vocational_year_graduated); ?>">
                </div>
                <div class="form-group col-md-6">
                    <i class="fas fa-school"></i>
                    <input type="text" name="other_school" class="form-control" placeholder="Other School Name" required value="<?php echo htmlspecialchars($other_school); ?>">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <i class="fas fa-book"></i>
                    <input type="text" name="other_school_course" class="form-control" placeholder="Other School Course" required value="<?php echo htmlspecialchars($other_school_course); ?>">
                </div>
                <div class="form-group col-md-6">
                    <i class="fas fa-calendar"></i>
                    <input type="number" name="other_year_graduated" class="form-control" placeholder="Other School Year Graduated" required value="<?php echo htmlspecialchars($other_year_graduated); ?>">
                </div>
            </div> -->
        ...
        <!-- <div class="step">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <i class="fas fa-university"></i>
                    <input type="text" name="church_name" class="form-control" placeholder="Name of Church you Attended" required value="<?php echo htmlspecialchars($church_name); ?>">
                </div>
                <div class="form-group col-md-6">
                    <i class="fas fa-university"></i>
                    <input type="text" name="church_address" class="form-control" placeholder="Church Address" required value="<?php echo htmlspecialchars($church_address); ?>">
                </div>
            </div> -->
            ...
            <!-- <div class="form-row">
                <div class="form-group col-md-6">
                    <i class="fas fa-university"></i>
                    <input type="text" name="name_pastor" class="form-control" placeholder="Name of Pastor" required value="<?php echo htmlspecialchars($name_pastor); ?>">
                </div>
                <div class="form-group col-md-6">
                    <i class="fas fa-university"></i>
                    <input type="number" name="pastor_no" class="form-control" placeholder="Pastor Contact Number" required value="<?php echo htmlspecialchars($pastor_no) ?>">
                </div>
            </div> -->
            ...
            <!-- <div class="form-row">
                <div class="form-group col-md-6">
                    <i class="fas fa-church"></i>
                    <input type="text" name="ministry_involved" class="form-control" placeholder="Ministry you're Involved" required value="<?php echo htmlspecialchars($ministry_involved); ?>">
                </div>
            </div> -->
        ...
        <!-- <div class="step">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="file" name="TOR" id="TOR" class="form-control" placeholder="TOR" required>
                </div>

                <div class="form-group col-md-6">
                    <i class="fas fa-file"></i>
                    <input type="file" name="pastor_reco" class="form-control" placeholder="Upload Pastor Recommendation Letter">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <i class="fas fa-file"></i>
                    <input type="file" name="stud_image" class="form-control" placeholder="Upload 1x1 Picture">
                </div>
                <div class="form-group col-md-6">
                    <i class="fas fa-file"></i>
                    <input type="file" name="form137" class="form-control" placeholder="Upload Form137" required>
                </div>
            </div>
        </div> -->
