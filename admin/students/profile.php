...
if (!isset($_GET['id'])) {
    echo "<script>alert('No student ID provided'); window.location.href='students.php';</script>";
    exit;
}
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            <div class="page-header">
                ...
                <ul class="breadcrumb">
                <li>
                    <a href="/Admin_Caps/admin/main.php" style="color: gray; text-decoration: none;">Home</a>
                </li>
                <li><i class='bx bx-chevron-right' >></i></li>
                <li>
                    <a href="/Admin_Caps/admin/applicants/applicants.php" style="text-decoration: none; color: gray;">New Applicants</a>
                </li>

                <li><i class='bx bx-chevron-right' >></i></li>

                <li>
                    <a class="active" href="/Admin_Caps/admin/report/report.php">Profile</a>
                </li>
   ...
   <div class="row">
    <div class="col-md-3">
     <div class="profile-image">
      <img alt="Profile image" style="margin-bottom: 35px;" height="150" src="<?php echo htmlspecialchars('/Admin_Caps/applicantsPortal/uploads/' . $student['stud_image']); ?>" width="150"/>
     </div>
      ...
      <div class="mb-3 row">
       ...
       <div class="col-sm-4">
        <div class="form-check form-check-inline">
         <input checked="" class="form-check-input" id="female" disabled readonly name="sex" type="radio" value="female" <?php echo ($student['sex'] == 'female') ? 'checked' : ''; ?> />
         <label class="form-check-label" for="female">
          Female
         </label>
        </div>
        <div class="form-check form-check-inline">
         <input class="form-check-input" id="male" name="sex" disabled readonly type="radio" value="male" <?php echo ($student['sex'] == 'male') ? 'checked' : ''; ?> />
       ...
       <!-- <div class="mb-3 row">
            ...
            <div class="row mb-3">
                <div class="col">
                    ...
                    <a href="/Admin_Caps/applicantsportal<?php echo $student['TOR']; ?>" target="_blank"><?php echo $student['TOR']; ?></a>
                </div>
                <!-- <div class="col">
            ...
            <div class="row mb-3">
                <div class="col">
                    ...
                    <a href="/Admin_Caps/applicantsportal<?php echo $student['stud_image']; ?>" target="_blank"><?php echo $student['stud_image']; ?></a>
                </div>
                <div class="col">
                    <label for="uploadedForm137" class="form-label">Form137</label>
                    <!-- <input type="file" class="form-control" id="uploadedForm137"> -->
                    <a href="/Admin_Caps/applicantsportal<?php echo $student['form137']; ?>" target="_blank"><?php echo $student['form137']; ?></a>
                </div>
            </div>
            <!-- <div class="row mb-3">
